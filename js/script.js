...
function formValidation() {
  ...
  if (ValidateEmail(uemail)) {
    if (ValidateFirstName(ufirstname)) {
      if (ValidateLastName(ulastname)) {
...
function ValidateFirstName(ufirstname) {
  var letters = /^[A-Za-z]+$/
...
function ValidateLastName(ulastname) {
  var letters = /^[A-Za-z]+$/
...
function formValidation1() {
  var uemail = document.registration.email;
  var uppassword = document.registration.ppassword;
  if (ValidateEmail(uemail)) {
    if (ValidatePPassword(uppassword)) {
    }
  } return false;
}
...
function ValidatePPassword(uppassword) {
  var letters = /^[A-Za-z]\w{7,14}$/
  if (uppassword.value.match(letters)) {
    alert('Login Successful');
    window.location.reload()
    return true;
  }
  else {
    alert('Please Input the Passowrd');
    uppassword.focus();
    return false;
  }
}
...
function formValidation2() {
  ...
  if (ValidateEmail(uemail)) {
    if (ValidatePassword(upassword)) {
      if (ValidateRepassword(urepassword, upassword)) {
        if (ValidateFirstName(ufirstname)) {
          if (ValidateLastName(ulastname)) {
...
function ValidateRepassword(urepassword, upassword) {
  if (urepassword.value === upassword.value) {
    return true;
...
function ValidateMobile(umobile) {
  ...
  if (umobile.value.match(letters)) {
    ...
    alert('Please Input the Valid Mobile');
    umobile.focus();
    return false;
  }
}